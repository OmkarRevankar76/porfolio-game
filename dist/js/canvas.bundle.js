...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "e7488899b5ce91a005eb9739bf379dfe.png");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "8f92ea1e2e6e76633a41d48674eb46e0.png");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "2a277694e4bce7142fd1d08c7ef186bf.png");
...
/* harmony import */ var _images_platformSmallTall_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../images/platformSmallTall.png */ "./src/images/platformSmallTall.png");
...
/* harmony import */ var _images_spriteStandLeft_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../images/spriteStandLeft.png */ "./src/images/spriteStandLeft.png");
/* harmony import */ var _images_spriteStandRight_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../images/spriteStandRight.png */ "./src/images/spriteStandRight.png");
...
console.log(_images_platform_png__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
var Player = /*#__PURE__*/function () {
  function Player() {
    ...
    this.width = 66;
    this.height = 150;
    this.image = createImage(_images_spriteStandRight_png__WEBPACK_IMPORTED_MODULE_6__["default"]);
    this.frame = 0;
    this.sprites = {
      stand: {
        right: createImage(_images_spriteStandRight_png__WEBPACK_IMPORTED_MODULE_6__["default"]),
        left: createImage(_images_spriteStandLeft_png__WEBPACK_IMPORTED_MODULE_5__["default"]),
        cropWidth: 177,
        width: 66
      },
      run: {
        right: createImage(_images_spriteRunRight_png__WEBPACK_IMPORTED_MODULE_3__["default"]),
...
var platformSmallTallImage = createImage(_images_platformSmallTall_png__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
function init() {
  ...
  platforms = [new Platform({
    x: platformImage.width * 5 + 300 + platformImage.width - platformSmallTallImage.width,
    y: 400,
    image: createImage(_images_platformSmallTall_png__WEBPACK_IMPORTED_MODULE_2__["default"])
  }), new Platform({
    ...
    x: platformImage.width * 10 + 1000,
    y: 250,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 11 + 600,
    y: 250,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 12 + 800,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 13 + 800,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 14 + 800,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 15 + 800,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 16 + 800,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 17 + 1000,
    y: 270,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 18 + 1000,
    y: 270,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 19 + 1000,
    y: 270,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 20 + 1200,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 21 + 1200,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 22 + 1500,
    y: 160,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 23 + 1500,
    y: 160,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 24 + 1530,
    y: 450,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 25 + 1530,
    y: 450,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 26 + 1530,
    y: 450,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 27 + 1580,
    y: 480,
    image: platformImage
